...
tarball="MLNX_OFED_LINUX-$mofed_version-$DISTRIBUTION.3-x86_64.tgz"
...
./$mofed_folder/mlnxofedinstall --add-kernel-support --skip-unsupported-devices-check --without-fw-update --skip-distro-check
